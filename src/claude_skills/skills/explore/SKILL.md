...
4. When swarm returns all results, collect each agent's `explorer_log.md` and concatenate them into `<OUTPUT_DIR>/report.md`. Then append a `## Synthesis` section weaving findings together.
