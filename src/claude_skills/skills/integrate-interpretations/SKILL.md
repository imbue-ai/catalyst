...
- When integrating solution candidates from the interpretation log, keep track of the best solution candidate seen so far in a short separate section of the theory. Include its solution ID (`U_...`) and verification experiment ID (`X_...`) for easy lookup.
