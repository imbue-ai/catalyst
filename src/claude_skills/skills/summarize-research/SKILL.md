...
- [ ] Option A: [Option text] -> Add to GUIDANCE.txt: "- [Sentence to add]"
- [ ] Option B: [Option text] -> Add to GUIDANCE.txt: "- [Sentence to add]"
- [ ] Option C: [Option text] -> Add to GUIDANCE.txt: "- [Sentence to add]"
