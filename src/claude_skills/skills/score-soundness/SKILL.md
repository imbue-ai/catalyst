...
3. **Review Falsification Reports**: Read the `review.md` files for each falsification review. Ignore any *experimental* falsifications! Instead, focus on *mathematical* falsifications that point out logical inconsistencies, mathematical errors, or flawed assumptions.
