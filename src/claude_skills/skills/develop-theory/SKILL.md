...
5. **Theory refinement**: Invoke the `refine-theory` skill to refine the theory (NOT in a subagent). You need to pass it the current theory ID. The skill will return a new theory ID.
