    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-[60]">
      <div className="bg-white border-2 border-red-600 p-8 w-full max-w-md shadow-[12px_12px_0px_0px_rgba(220,38,38,1)] no-invert">
        ...
        <div className="flex gap-4">
          <button 
            onClick={onClose}
            className="flex-1 border border-black p-4 font-black text-sm tracking-widest hover:bg-gray-100"
          >
            Cancel
          </button>
          <button 
            ...
            className="flex-1 bg-red-600 text-white p-4 font-black text-sm tracking-widest hover:bg-red-700 disabled:opacity-30 disabled:cursor-not-allowed"
          >
            Delete Task
          </button>
        </div>
